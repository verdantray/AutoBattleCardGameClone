Shader "Neon/Object/ObjectIngameShader_Transparent_StencilOutline"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float2 screenFitUv = float2(i.screenPos.x, i.screenPos.y)/i.screenPos.w;
                float3 opaqueTexture = SAMPLE_TEXTURE2D(_GrapPassTexture, sampler_MainTex, screenFitUv).rgb;
