Shader "Neon/Object/ObjectIngameShader_StencilOutline"
{
    Properties
    {
        ...
        [Enum(UnityEngine.Rendering.CullMode)] _OutlineCull("Outline Cull", Integer) = 2
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile _MAIN_LIGHT_SHADOWS_CASCADE _MAIN_LIGHT_SHADOWS_SCREEN
        ...
        Pass
        {
            ...
            // #pragma shader_feature_local _ _USEBAKEDNORMAL_ON
            ...
            v2f vert (appdata v)
            {
                ...
                _OutlineWidth *= unity_OrthoParams.w ? 10 : 1;
